<template>
  <div class="love-shop" id="love-shop">
    <header class="page-header">
      ...
      <div class="header-content">优质卖家</div>
            ...
            <ul class="shop-content">
              <li class="shop-item">
                <div class="item-header">
                  <img class="store-logo" src="../../assets/home/demo4.png" />
                  <div class="item-text">
                    <p>仙于</p>
                    <!-- <i>正品大牌 产家直营</i> -->
                  </div>
                ...
                <div class="item-iamgs">
                  <div class="left-imags">
                    <img src="../../assets/classifyNursing/美妆-1.png" />
                  </div>
                  <div class="right-imags">
                    <img src="../../assets/classifyNursing/美妆-2.png" />
                    <img src="../../assets/classifyNursing/美妆-3.png" />
                  </div>
                </div>
              </li>
              <li class="shop-item">
                <div class="item-header">
                  <img class="store-logo" src="../../assets/home/demo4a.png" />
                  <div class="item-text">
                    <p>花屋</p>
                    <!-- <i>正品大牌 产家直营</i> -->
                  </div>
                ...
                <div class="item-iamgs">
                  <div class="left-imags">
                    <img src="../../assets/classifyNursing/美妆-4.png" />
                  </div>
                  <div class="right-imags">
                    <img src="../../assets/classifyNursing/美妆-5.png" />
                    <img src="../../assets/classifyNursing/美妆-6.png" />
                  </div>
                </div>
              </li>
            </ul>
