  ...
  <ul class="chain-cat-spike" id="chain-cat-spike">
    <header class="page-header">
      ...
      <div class="header-content">
        <div>今日成交价格</div>
        <p style="font-size: 13px;">2025/5/16 18:00:00</p>
      </div>
    </header>
    ...
    <ul class="page-tabs">
     <!-- <main class="main-box">
          ...
          <img src="/image/微信图片_20250516171436.png" alt="" style="width: 100vw; height: auto;">
    </ul>
    <van-popup
      v-model="show"
      round
      ...
      cardList: [
        {
          ...
          price: "￥88",
          oldPrice: "￥58",
          img:require('@/assets/home/demo1.png')
        },
        {
          title: "【伯牙绝弦】12朵茉莉白百合",
          name: "伯牙绝弦",
          price: "￥20",
          oldPrice: "￥40",
            img:require('@/assets/home/demo2b.png')
        },
        {
          title: "【万象春和】17朵郁金香",
          name: "万象春和",
          price: "￥70",
          oldPrice: "￥120",
             img:require('@/assets/home/demo10.png')
        }
      ],
      tabList: [
        {
